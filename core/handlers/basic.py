...
async def get_start(message: Message, bot: Bot) -> None:
  ...
  await bot.send_photo(chat_id=message.chat.id, photo='AgACAgIAAxkBAAM5Zg8ZGlMXFVPmCpCP-rfk3DstbKEAAtHaMRsqD3hIhX3bOM8WgioBAAMCAAN5AAM0BA', caption=message_text, reply_markup=main_menu_admin_ikb())

""" Команда помощи """
@router.message(Command("help"))
async def get_help_me(message: Message, bot: Bot) -> None:
  message_text = "Я бот который поздравляет людей с их днем рождения.\nВведи команду /start чтобы начать"
